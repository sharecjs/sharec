...
module.exports = [
  ...
  ['/^root:/{s/^[^:]*:[^:]*:([^:]*).*$/\\1/', ['/^root:/{s/^[^:]*:[^:]*:([^:]*).*$/\\1/'], { nonull: true }],
  ['/^root:/{s/^[^:]*:[^:]*:([^:]*).*$/\u0001/', ['/^root:/{s/^[^:]*:[^:]*:([^:]*).*$/\u0001/'], { nonull: true }],
  ...
  ['[ia]?[ck]', ['ABC', 'IjK'], { nocase: true, null: true }, ['xYz', 'ABC', 'IjK']],
  ...
  function () {
    fixtures = ['foo.js', 'foo.bar', 'foo.js.js', 'blar.js', 'foo.', 'boo.js.boo']
  },
