...
This is a fork of the [original nanomatch](https://github.com/micromatch/nanomatch). It was maded just because required functionality was not merged by repository maintainers, [PR](https://github.com/micromatch/nanomatch/pull/27) is still open. Probably, after the merge – this package will be deprecated, but at this moment we have what we have.
...
```sh
$ npm install --save sharec-nanomatch
```
...
```js
var nanomatch = require('sharec-nanomatch');
...
```js
var nm = require('sharec-nanomatch')
